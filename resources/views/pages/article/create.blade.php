<x-guest-layout>
    ...
    <section class="container">
        <form class="my-14 w-full" action={{ route('tips-trick.store') }} method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6">
                ...
                <img id="preview" class="hidden aspect-square object-cover w-72 mb-3 " alt="">
                <input
            ...
            <div class="mb-6">
                ...
                <textarea id="myeditorinstance" name="content" placeholder="Tulis Artikel disini"></textarea>
                @error('content')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
